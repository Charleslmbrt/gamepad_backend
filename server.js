...
app.get("/", async (req, res) => {
  try {
    ...
    const response = await axios.get(
      ...
      `https://api.rawg.io/api/games?key=${process.env.API_KEY}&search=${req.query.search}&page=${req.query.page}&page_size=${req.query.page_size}&genres=${genre}&platforms=${platforms}`
    );
